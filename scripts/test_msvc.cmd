...
cl /nologo /std:c++17 /EHsc /utf-8 /W4 /Iinclude tests\test_inventory.cpp src\Product.cpp src\CsvUtil.cpp src\InventoryManager.cpp /Fo:build\ /Fe:build\test_inventory.exe
if errorlevel 1 exit /b %errorlevel%
